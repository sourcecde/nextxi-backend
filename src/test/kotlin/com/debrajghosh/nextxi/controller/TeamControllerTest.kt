...
class TeamControllerTest {
    ...
    fun `should return all teams`() {
        val teams = listOf(
            TeamDTO(1L, 157, 1L, "Bayern Munich", "BAY", "Germany", 1900, false, "https://media.api-sports.io/teams/1.png"),
            TeamDTO(2L, 33, 3L, "Manchester United", "MNU", "England", 1878, false, "https://media.api-sports.io/teams/2.png"),
            TeamDTO(3L, 85, null, "Paris Saint-Germain", "PSG", "France", 1970, false, "https://media.api-sports.io/teams/3.png")
        )
        ...
        mockMvc.perform(get("/api/v1/teams"))
            ...
            .andExpect(jsonPath("$[0].teamId").value(157))
            ...
            .andExpect(jsonPath("$[1].teamId").value(33))
            .andExpect(jsonPath("$[1].code").value("MNU"))
            .andExpect(jsonPath("$[2].name").value("Paris Saint-Germain"))
            .andExpect(jsonPath("$[2].teamId").value(85))
    }

    @Test
    fun `should return team by id`() {
        val team = TeamDTO(1L, 157, 1L, "Bayern Munich", "BAY", "Germany", 1900, false, "https://media.api-sports.io/teams/1.png")
        ...
        mockMvc.perform(get("/api/v1/teams/1"))
            ...
            .andExpect(jsonPath("$.teamId").value(157))
    ...
    fun `should return team by team id`() {
        ...
        given(teamService.getTeamByTeamId(anyInt())).willReturn(team)

        mockMvc.perform(get("/api/v1/teams/team-id/157"))
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.name").value("Bayern Munich"))
            .andExpect(jsonPath("$.teamId").value(157))
            .andExpect(jsonPath("$.code").value("BAY"))
    ...
    @Test
    fun `should return 404 when team team id is not found`() {
        given(teamService.getTeamByTeamId(anyInt())).willReturn(null)
    ...
    fun `should return teams by country`() {
        val teams = listOf(
            TeamDTO(1L, 157, 1L, "Bayern Munich", "BAY", "Germany", 1900, false, "https://media.api-sports.io/teams/1.png"),
            TeamDTO(4L, 25, null, "Germany", "GER", "Germany", 1908, true, "https://media.api-sports.io/teams/4.png")
        )
    ...
    fun `should return national teams`() {
        val teams = listOf(
            TeamDTO(4L, 25, null, "Germany", "GER", "Germany", 1908, true, "https://media.api-sports.io/teams/4.png"),
            TeamDTO(5L, 2, null, "France", "FRA", "France", 1904, true, "https://media.api-sports.io/teams/5.png")
        )
    ...
    fun `should return teams by venue`() {
        val teams = listOf(
            TeamDTO(1L, 157, 1L, "Bayern Munich", "BAY", "Germany", 1900, false, "https://media.api-sports.io/teams/1.png"),
            TeamDTO(6L, 100, 1L, "Another Team", "ANT", "Germany", 2000, false, "https://media.api-sports.io/teams/6.png")
        )
